...
namespace HoteldosNobresBlazor.Funcoes
{
    public class FunctionWhatsApp
    {
        ...
        public static async Task<string> postMensagemTempleteDadosFaltando(string numero, string reservaID, string Nome, string link)
        {
            try
            { 
                var client = new HttpClient();
        ...
        public static async Task<string> postMensagemTempleteFeedback(string numero, string reservaID, string Nome)
        {
            try
            {
